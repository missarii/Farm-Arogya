...
// -----------------------------
// Imports: make sure these files exist in src/assets/
// -----------------------------
...
// Soil Test images (you can reuse any existing images if you prefer)
...
// -----------------------------
// Reactive states (current images shown on each card)
// -----------------------------
...
// -----------------------------
// Image arrays (one declaration each, no duplicates)
// -----------------------------
...
// -----------------------------
// Hover handlers — change small card image + background
// -----------------------------
...
const handleSoilHover = () => {
  setBg('soiltest')
  soilIndex = (soilIndex + 1) % soilImages.length
  currentSoilImg.value = soilImages[soilIndex]
}

const handleToolsHover = () => {
  setBg('tools')
  toolsIndex = (toolsIndex + 1) % toolsImages.length
  currentToolsImg.value = toolsImages[toolsIndex]
}

const handleFertilizerHover = () => {
  setBg('fertilizer')
  fertilizerIndex = (fertilizerIndex + 1) % fertilizerImages.length
  currentFertilizerImg.value = fertilizerImages[fertilizerIndex]
}
...
const bgMap = {
  ...
  soiltest: [
    '/images/SoilTest/1.jpg',
    '/images/SoilTest/2.jpg'
  ...
  fertilizer: [
    '/images/Fertilizer/1.jpg',
    '/images/Fertilizer/2.jpg'
...
// -----------------------------
// Browser check for gradient animation
// -----------------------------
...
/* ======================================
   Options Layout — 3 + 3 Clean Layout
====================================== */
.options {
  display: grid;
